...
(*     ("reacq"). This is the shipping code; TokenPool_PromptRelease.cfg   *)
(*     predicts its deadlock: every other token ends up held by a job      *)
(*     blocked on the prompter's lock, and the prompter spins forever.     *)
